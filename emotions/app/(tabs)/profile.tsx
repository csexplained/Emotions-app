      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          <View style={{ marginBottom: 20 }}>
            <Pressable onPress={() => console.log("dasdw")} className="w-full h-12 flex justify-center items-center bg-[#04714A] rounded-lg active:opacity-80">

const activitiesData = [
  ...
  },
  {
    ...
    description: "Break down fear by writing and reflecting on your thoughts.",
    tags: ["Fear", "Journaling", "Clarity", "Writing"],
    duration: "10 min",
    image: require('@/assets/images/ActivityCard.png'),
    colors: ["#FFF4E7", "#FFD19E"] as [string, string],
    redirect: "/Trainings/trainingscreen",
    data: {
      ...
      currentStep: 2,
      totalSteps: 4,
      exerciseName: "Journaling Prompt",
      time: "10 min",
      distance: "N/A",
      difficulty: "Medium",
      description: "Convert vague fear into clear thoughts by answering guided prompts in a journal.",
      steps: [
        "Step 1 - What am I afraid of?",
        "Step 2 - Why do I feel this fear?",
        "Step 3 - What’s the worst-case scenario?",
        "Step 4 - How likely is it and how can I prepare?"
      ]
    }
  },
  {
    id: "401",
    type: "Sorrow",
    title: "Acceptance & Acknowledgment",
    description: "Honor your sorrow instead of suppressing it.",
    tags: ["Sorrow", "Acceptance", "Healing", "Peace"],
    duration: "10 min",
    image: require('@/assets/images/ActivityCard.png'),
    colors: ["#E7F3FF", "#9ECBFF"] as [string, string],
    redirect: "/Trainings/trainingscreen",
    data: {
      ...
      currentStep: 1,
      totalSteps: 3,
      exerciseName: "Sitting with Sorrow",
      time: "10 min",
      distance: "N/A",
      difficulty: "Medium",
      description: "Let yourself feel sorrow fully, with compassion and grace.",
      steps: [
        "Step 1 - Sit in a quiet space, breathe gently.",
        "Step 2 - Say: 'It’s okay to feel this way.'",
        "Step 3 - Place your hand on your heart and breathe into the pain."
      ]
    }
  },
  {
    ...
    description: "Transform sorrow into poetry, drawing, or music.",
    tags: ["Sorrow", "Creativity", "Healing", "Art"],
    duration: "15 min",
    image: require('@/assets/images/ActivityCard.png'),
    ...
    data: {
      ...
      currentStep: 1,
      totalSteps: 3,
      exerciseName: "Art for Healing",
      time: "15 min",
      distance: "N/A",
      difficulty: "Easy",
      description: "Channel deep emotions into something beautiful and meaningful.",
      steps: [
        "Step 1 - Choose your medium: write, draw, paint, or sing.",
        "Step 2 - Let go of perfection—just feel and express.",
        "Step 3 - Reflect on what your creation tells you."
      ]
    }
  },
  {
    ...
    type: "Confusion",
    title: "Mind Mapping",
    description: "Visually untangle your thoughts to gain clarity.",
    tags: ["Confusion", "Clarity", "Thinking", "Focus"],
    duration: "10 min",
    image: require('@/assets/images/ActivityCard.png'),
    ...
    data: {
      ...
      currentStep: 1,
      totalSteps: 4,
      exerciseName: "Visual Thought Organizer",
      time: "10 min",
      distance: "N/A",
      difficulty: "Easy",
      description: "Give shape to scattered thoughts through a mind map.",
      steps: [
        "Step 1 - Write your main confusion in the center.",
        "Step 2 - Add branches with related thoughts or fears.",
        "Step 3 - Highlight key patterns or overlaps.",
  ...
  },
  {
    ...
    description: "Reduce overwhelm by taking one small action.",
    tags: ["Confusion", "Overthinking", "Simplify", "Action"],
    duration: "5 min",
    image: require('@/assets/images/ActivityCard.png'),
    colors: ["#E7F9FF", "#9EE6FF"] as [string, string],
    redirect: "/Trainings/trainingscreen",
    data: {
      ...
      currentStep: 1,
      totalSteps: 3,
      exerciseName: "Clarity by Action",
      time: "5 min",
      distance: "N/A",
      difficulty: "Easy",
      description: "Stop spinning. Pick one thing to act on now and build momentum.",
      steps: [
        "Step 1 - List 3 aspects of the issue.",
        "Step 2 - Choose the easiest to start with.",
  ...
  },
  {
    ...
    description: "Feel joy by focusing on what’s already good in your life.",
    tags: ["Happiness", "Gratitude", "Positivity", "Joy"],
    duration: "7 min",
    image: require('@/assets/images/ActivityCard.png'),
    ...
    data: {
      ...
      currentStep: 1,
      totalSteps: 3,
      exerciseName: "Daily Gratitude",
      time: "7 min",
      distance: "N/A",
      difficulty: "Easy",
      description: "Write down three things you’re grateful for today. Reflect on how they make you feel.",
      steps: [
        "Step 1 - List 3 things you’re grateful for.",
        "Step 2 - Note why they matter to you.",
        "Step 3 - Re-read your list with a smile."
      ]
    }
  },
  {
    ...
    description: "Lift your mood by spreading kindness to others.",
    tags: ["Happiness", "Kindness", "Connection", "Compassion"],
    duration: "10 min",
    image: require('@/assets/images/ActivityCard.png'),
    colors: ["#E7FFF4", "#9EFFCE"] as [string, string],
    redirect: "/Trainings/trainingscreen",
    data: {
      ...
      currentStep: 1,
      totalSteps: 3,
      exerciseName: "Intentional Goodness",
      time: "10 min",
      distance: "N/A",
      difficulty: "Easy",
      description: "Do something thoughtful today and notice how it makes both of you feel.",
      steps: [
        "Step 1 - Choose someone to uplift today.",
        "Step 2 - Do one kind act (call, note, smile, help).",
        "Step 3 - Reflect: How did it feel to give?"
      ]
    }
  },
  {
